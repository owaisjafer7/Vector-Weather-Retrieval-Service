...
- Flask REST API
- Syncs NWS weather data into Lakebase
- Searches weather documents using pgvector similarity
- Supports source_type filtering (Stretch Goal #4)
"""
...
def weather_search_logic(query, top_k, source_type=None):
    """
    Shared semantic search logic.
    Supports optional filtering by source_type.
    """
